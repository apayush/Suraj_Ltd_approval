...
class SalesOrderDataSource extends DataGridSource {
  List<VoucherModel> salesOrderList = [];
  ...
  void _loadInitialPage() {
    paginatedItems = salesOrderList.take(rowsPerPage).toList();
    _buildDataGridRows();
  }
  ...
  DataGridRowAdapter buildRow(DataGridRow row) {
    ...
    VoucherModel model = salesOrderList[rowIndex];
  ...
  Future<bool> handlePageChange(int oldPageIndex, int newPageIndex) async {
    ...
    if (startIndex < salesOrderList.length) {
      paginatedItems =
          salesOrderList
              .getRange(
            startIndex,
