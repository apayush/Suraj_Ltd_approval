...
class PurchaseIndentDataSource extends DataGridSource {
  List<VoucherModel> purchaseIndentList = [];
  ...
  void _loadInitialPage() {
    paginatedItems = purchaseIndentList.take(rowsPerPage).toList();
    _buildDataGridRows();
  }
  ...
  DataGridRowAdapter buildRow(DataGridRow row) {
    ...
    VoucherModel model = purchaseIndentList[rowIndex];
  ...
  Future<bool> handlePageChange(int oldPageIndex, int newPageIndex) async {
    ...
    if (startIndex < purchaseIndentList.length) {
      paginatedItems =
          purchaseIndentList
              .getRange(
                startIndex,
