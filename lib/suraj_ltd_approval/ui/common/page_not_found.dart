...
import 'package:shared_component/controllers/home_controller.dart';
import '../widgets/common_widgets/app_image_assets.dart';
import '../widgets/common_widgets/app_text.dart';
  ...
  Widget _buildWebLayout(BuildContext context) {
    return Column(
      children: [
        Expanded(
            flex: 2,
            child: AppText("Sorry, we couldn't find that page…",
