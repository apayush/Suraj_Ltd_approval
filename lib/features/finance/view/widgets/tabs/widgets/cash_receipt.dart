...
class CashReceipt extends GetView<FinanceController> {
  CashReceipt({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        10.heightGap,
        Obx(() => buildCashReceiptTable(context)),
      ],
    );
  }

  Widget buildCashReceiptTable(BuildContext context) {
    return controller.cashReceiptList.isNotEmpty
        ? Expanded(
      child: Obx(() {
        return SfDataGridPaginationWithAllData(
          controller: controller,
          source: controller.cashReceiptDataSource,
          totalItems: controller.cashReceiptList.length,
